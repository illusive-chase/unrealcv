...
FExecStatus FExecStatus::InvalidArgument = FExecStatus(FExecStatusType::NOT_OK, "Argument Invalid");
FExecStatus FExecStatus::NotImplemented = FExecStatus(FExecStatusType::NOT_OK, "Not Implemented");
FExecStatus FExecStatus::InvalidPointer = FExecStatus(FExecStatusType::NOT_OK, "Pointer to object invalid, check log for details");
...
{
	return FExecStatus(FExecStatusType::NOT_OK, ErrorMessage);
}
